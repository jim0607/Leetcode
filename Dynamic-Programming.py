...
第三讲：划分型动态规划 
91. Decode Ways
状态往往定义为前j个的某种特性，不包括j！！！！，这个思想很重要，相当于给前面做了一层buffer layer, 注意有了buffer layer之后，dp中的 i 对应的是nums中的 i-1 !!!!!!!
...
一定要用一个buffer layer！！！初始条件就是处理空串！注意有了buffer layer之后，dp中的 i 对应的是nums中的 i-1 !!!!!!!
初始条件和边界情况
– 空串如何处理
