    ...
    def findMin(self, nums: List[int]) -> int:
        ...
        while start + 1 < end:
            ...
            if nums[mid] < nums[end]:
                ...
                start = mid
            elif nums[mid] == nums[end]:  # 注意这里是不能drop掉一半的地方，所以如果nums里面有很多相等的数，
                end -= 1            # eg: nums=[2,2,1,2,2,2,2,2,2,2,2,2,2..........],那每次都是将end往后挪一位，而不是二分法希望的drop half,所以in extreme case, 时间复杂度是O(N)
