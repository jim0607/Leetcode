...
"""
work backwards: we compare tx and ty, whenever we found tx > ty, we update tx: tx -= ty. 
else we update ty: ty -= tx.  we update tx and ty all the way until we reach sx and sy.
O(max(tx, ty))
"""
class Solution:
